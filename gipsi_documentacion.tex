...
PF-D04 & Repetir la consulta añadiendo \texttt{workerId} en un negocio con varios trabajadores y comprobar que la respuesta incluye \texttt{availableWorkerIds}. & \TestFile{pf-d04-disponibilidad-multiworker.png} \\
\bottomrule
\end{tabularx}
\end{table}
